...
function get_heatpump_stats($feed,$app,$start,$end,$starting_power,$timezone = 'Europe/London') {
    ...
    $feeds = array("heatpump_elec","heatpump_flowT","heatpump_returnT","heatpump_outsideT","heatpump_roomT","heatpump_heat","heatpump_dhw","heatpump_error","heatpump_cooling","immersion_elec", "solar_irradiation");
...
function process_stats($data, $interval, $starting_power) {
    ...
    $feed_options = [
        ...
        "solar_irradiation" => ["name" => "Solar Irradiation", "unit" => "W/m²", "dp" => 1],
    ];
